...
class ServiceHaircutAdapter(
    var context: Context
) :
    RecyclerView.Adapter<ServiceHaircutAdapter.Holder>() {

    private var currentSelection = 0

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        return Holder(
            LayoutInflater.from(parent.context).inflate(R.layout.item_hair_service, parent, false)
        )
    }
